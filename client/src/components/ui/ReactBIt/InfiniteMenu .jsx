  ...
  return (
    <div className="relative w-full h-[80vh]  overflow-hidden ">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab  w-full h-full overflow-hidden relative outline-none active:cursor-grabbing rounded-full "
      />
      ...
      {activeItem && (
        <>
          {/* Title */}
          <h1
            className={`custom-class text-lg  px-4 py-2  w-1/2 font-bold tracking-tight text-center  
  absolute  bg-amber-500/70 text-white  rounded-4xl
          left-1/2
        bottom-1/4
          transform
          translate-x-[-50%]
